...
var Planet = function (_Component) {
  ...
  function Planet(props) {
    ...
    _this.state = {
      planetShine: 5 + _this.props.scrolled * -2
    };
    return _this;
  }
  ...
  _createClass(Planet, [{
    ...
    value: function render() {
      var scrolled = this.props.scrolled;
      var planetShine = this.state.planetShine;

      return _react2.default.createElement(
        'div',
        { style: styles.outer },
        _react2.default.createElement('div', { style: {
            background: 'rgba(130, 175, 175, 0.65)',
            width: '30vw',
            height: '30vw',
            borderRadius: '50%',
            boxShadow: '0 ' + planetShine + 'px 10px rgb(255, 221, 56),\n                      0 ' + planetShine + 'px 5px white'
          } }),
        _react2.default.createElement('div', { style: {
            position: 'relative',
