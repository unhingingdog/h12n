...
var Planet = function (_Component) {
  ...
  function Planet(props) {
    ...
    return _possibleConstructorReturn(this, (Planet.__proto__ || Object.getPrototypeOf(Planet)).call(this, props));
  }
  ...
  _createClass(Planet, [{
    ...
    value: function render() {
      ...
      var planetShine = this.props.scrolled * -1;
      // const planetShadow =
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('div', { style: {
            ...
            height: '30vw',
            borderRadius: '50%',
            boxShadow: '0 ' + (5 + planetShine * 2) + 'px 10px rgb(255, 221, 56),\n                      0 ' + (3 + planetShine) + 'px 5px white'
          } }),
        _react2.default.createElement('div', { style: {
            position: 'relative',
