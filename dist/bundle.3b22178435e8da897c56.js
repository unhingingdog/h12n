...
var Planet = function (_Component) {
  ...
  function Planet(props) {
    ...
    _this.horizonShine = _this.horizonShine.bind(_this);
    _this.planetShadowSpread = _this.planetShadowSpread.bind(_this);
    _this.planetStyleProperties = _this.planetStyleProperties.bind(_this);
    return _this;
  }
  ...
  _createClass(Planet, [{
    ...
    value: function planetStyleProperties() {
      var scrolled = this.props.scrolled;
    ...
    key: 'render',
    value: function render() {
      var planetStyles = this.planetStyleProperties();
      var scrolled = this.props.scrolled;
